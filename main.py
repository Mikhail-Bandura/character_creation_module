...
def defence(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'healer':
        ...
        return ('{} блокировал {} урона'.format(char_name, 10 + randint(2, 5)))


def special(char_name: str, char_class: str) -> str:
    """Проверяет спициальное умение."""
...
def main():
    """Предлагает написать имя, выбрать класс, начать тренировку."""
